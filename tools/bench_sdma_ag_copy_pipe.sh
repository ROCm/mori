...
#   PIPELINE_CU=224 PIPELINE_CHUNKS=4 RUN_CHUNKED_DIRECT=1 RUN_ONESHOT_DIRECT=0 \
...
grep -E "MORI_CHUNKED_DIRECT|MORI_ONESHOT_DIRECT|MORI_SDMA_AG_COPY_PIPE|Table 1:|copy vs RCCL|Copy-path|host-side hipMemcpy|gpu-side copy|AR\\[[0-3]\\] duration|median wall" "$LOG" || true
